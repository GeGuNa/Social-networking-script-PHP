...
function getAudioContext() {
  ...
  return (window.AudioContext && new AudioContext()) || (window.webkitAudioContext && new webkitAudioContext());
}
...
function getUserMedia(...args) {
  ...
  return 
		 navigator.mediaDevices.getUserMedia && navigator.mediaDevices.getUserMedia(...args) ||
