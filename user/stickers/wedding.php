...
if (isset($er1)) {
	...
	$pdo->query("INSERT INTO `user_stickers` (`who`, `user`, `time`, `sticker_id`, `when`, `type`) VALUES(?,?,?,?,?,?)", [$ank['id'], $user['id'], $time2, $idpst, $time, 'wedding']);
...
<? foreach(range(1,22) as $val) { ?>

<img width="60" height="60" src='/img/stickers/wedding/<?php echo $val;?>.png'>
