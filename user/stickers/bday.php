...
if (isset($er1)) {
	...
	$pdo->query("INSERT INTO `user_stickers` (`who`, `user`, `time`, `sticker_id`, `when`, `type`) VALUES(?,?,?,?,?,?)", [$ank['id'], $user['id'], $time2, $idpst, $time, 'bday']);
...
<? foreach(range(1,19) as $val) { ?>

<img width="60" height="60" src='/img/stickers/bday/<?php echo $val;?>.png'>
