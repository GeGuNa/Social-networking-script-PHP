...
$kqlkpid = filter($_GET['post']);

$post = $pdo->fetchOne("SELECT * FROM `notes_komm` WHERE `id` = ?", [$kqlkpid]);
...
<?
$qq->setPage("/page/posts/reacts.php?", "post=$post[id]");
...
<div class="Lfoot">
 <a href="/page/posts/?id=<?=$post['id_notes'];?>">Back</a>
</div>
