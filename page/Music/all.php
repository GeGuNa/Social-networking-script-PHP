...
$kzftch322 = $pdo->query("SELECT * FROM `post_music`")->rowCount();
...
$qfetch = $pdo->query("SELECT * FROM `post_music`  ORDER BY `uid` DESC LIMIT $ttlq, $set[p_str]");
