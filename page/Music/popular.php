...
$kzftch322 = $pdo->query("SELECT * FROM `post_music` WHERE `likes` > ?",[0])->rowCount();
...
$qfetch = $pdo->query("SELECT * FROM `post_music` WHERE `likes` > ? ORDER BY `likes` DESC LIMIT $ttlq, $set[p_str]", [0]);
...
$qq->setPage("/page/Music/popular.php");
